...
export default function AdminQuotations() {
  ...
  const handleSave = async () => {
    ...
    try {
      await adminApi.createQuotation({ ...form, items: form.items.map(it => ({ ...it })) });
      toast.success('Quotation created'); setDialogOpen(false); load(1);
    ...
    <div className="space-y-6">
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
          ...
          <DialogFooter><Button variant="outline" onClick={() => setDialogOpen(false)}>Cancel</Button><Button onClick={handleSave}>Create Quotation</Button></DialogFooter>
        </DialogContent>
      </Dialog>
