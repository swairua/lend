...
export default function AdminDashboard() {
  ...
  const statCards = [
    { title: 'Total Borrowers', value: stats?.total_borrowers || 0, icon: Users, color: 'bg-blue-500', change: `${stats?.changes?.borrowers || 0}%` },
    { title: 'Total Loans', value: stats?.total_loans || 0, icon: FileText, color: 'bg-purple-500', change: `${stats?.changes?.loans || 0}%` },
    { title: 'Active Loans', value: stats?.active_loans || 0, icon: CreditCard, color: 'bg-green-500', change: `${stats?.changes?.active_loans || 0}%` },
    { title: 'Total Disbursed', value: formatKES(stats?.total_disbursed || 0), icon: DollarSign, color: 'bg-red-500', change: `${stats?.changes?.disbursed || 0}%` },
    { title: 'Total Collected', value: formatKES(stats?.total_collected || 0), icon: Wallet, color: 'bg-emerald-500', change: `${stats?.changes?.collected || 0}%` },
  ];
